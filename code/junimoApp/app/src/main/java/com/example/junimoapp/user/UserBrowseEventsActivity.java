package com.example.junimoapp.user;
...
import com.example.junimoapp.admin.AdminEventAdapter;
 ...
 */
public class UserBrowseEventsActivity extends AppCompatActivity {

    // tag used for Logcat filtering when debugging this Activity
    private static final String TAG = "UserBrowseEvents";
